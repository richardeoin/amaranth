...
class LatticeNexusPlatform(TemplatedPlatform):
    ...
    _nextpnr_device_options = {}  # TODO

    _nextpnr_package_options = {}  # TODO

    _oxide_required_tools = []  # TODO
    ...
    _oxide_command_templates = []  # TODO

    # Radiant templates

    _radiant_required_tools = ["yosys", "radiantc"]
    ...
    def __init__(self, *, toolchain="Oxide"):
        ...
        assert toolchain in ("Radiant"), "Project Oxide not yet supported"
    ...
    def create_missing_domain(self, name):
        # Lattice LFD2NX devices have two global set/reset signals: PUR, which is driven at startup
        ...
        if name == "sync" and self.default_clk is not None:
            ...
            gsr0 = Signal()
            gsr1 = Signal()
            # On LFD2NX all the D-type FFs have either an synchronous or asynchronous preset. Here
    ...
    # From Lattice FPGA-TN-02067-1.8 Section 6 Software sysI/O Attributes
    ...
    def should_skip_port_component(self, port, attrs, component):
        # On LFD2NX, a differential IO is placed by only instantiating an IO buffer primitive at
